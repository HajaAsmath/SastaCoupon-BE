...
const insertCoupon = (coupon) => {
  ...
  return db.promise().query(
    'INSERT INTO COUPON (NAME, DESCRIPTION, EXPIRY, PRICE, SELLER_ID, IMAGE_ID, COUPON_CODE) VALUES (?, ?, ?, ?, ?, ?, ?)',
    [coupon.couponName,
      coupon.couponDiscription,
      expiryDate, coupon.denomination, coupon.userId, coupon.imageId, coupon.couponCode],
  );
};
